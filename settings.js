...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&juNA7HMe' : process.env.SESSION_ID, // put your session id || ඔයාගෙ සෙසන් එක දාන්න...😌❤
...
SUDO: process.env.SUDO === undefined ? '94 72859 1962' : process.env.SUDO,
